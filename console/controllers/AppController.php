...
class AppController extends Controller
{
    ...
    public function actionSetup()
    {
        ...
        echo "############ Users module ############\n";
        \Yii::$app->runAction('migrate/up', ['migrationPath' => '@vendor/dektrium/yii2-user/migrations', 'interactive' => $this->interactive]);
        echo "############ Rbac ############\n";
        \Yii::$app->runAction('migrate/up', ['migrationPath' => '@common/migrations/rbac', 'interactive' => $this->interactive]);
        echo "############ Demo users ############\n";
        \Yii::$app->runAction('migrate/up', ['migrationPath' => '@common/migrations/demo', 'interactive' => $this->interactive]);
    }
